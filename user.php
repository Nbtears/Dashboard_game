    ...
    <div class="col-3">
      <div class="card bg-success bg-opacity-25" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <p class="card-text text-center">Nombre: <?php echo $username?></p></p>
          <p class="card-text text-center">Apellidos: <?php echo $username?></p></p>
          <p class="card-text text-center">Edad: <?php echo $username?></p></p>
        </div>
      </div>
    </div>
